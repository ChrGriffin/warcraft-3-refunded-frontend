...
<style scoped lang="scss">
    ...
    section {
        background-image: linear-gradient(to left, rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0)), url("https://bnetcmsus-a.akamaihd.net/cms/template_resource/QS9WH3KDU30U1541005854721.jpg");
